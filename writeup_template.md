...
![Picture 4](./pictures/theta3.jpg)

θ<sub>3</sub> is an angle between X<sub>2</sub> and X<sub>3</sub> measured over Z<sub>3</sub>. From the picture above we can conclude that θ<sub>3</sub> = (b - d), where d = atan3(d4,a3). 
